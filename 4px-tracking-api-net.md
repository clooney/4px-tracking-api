4PX Tracking API - .Net
================================
Use .Net to track 4PX shipments with 4PX Tracking API.
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  createTrackingParams.trackingNumber = "4PX3001518625089CN";
                  createTrackingParams.courierCode = "4px";
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  {
                      trackingNumber = "4PX3001359756959CN",
                      courierCode = "4px"
                  };
                  ...
                  {
                      trackingNumber = "4PX3001490035975CN",
                      courierCode = "4px"
                  };
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  # getTrackingResultsParams.trackingNumbers = "4PX3001359756959CN,4PX3001490035975CN";
                  getTrackingResultsParams.courierCode = "4px";
