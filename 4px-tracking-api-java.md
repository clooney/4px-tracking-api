4PX Tracking API - Java
================================
Use Java to track 4PX shipments with 4PX Tracking API.

Features
--------
- Real-time 4PX tracking.
- Batch 4PX tracking.
- Other features to manage your 4PX tracking.
...
Then, start to track your 4PX shipments.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.4px;
    ...
    public class Create4PXTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setTrackingNumber("4PX3001518625089CN");
                createTrackingParams.setCourierCode("4px");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class Create4PXTrackingsExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams1.setTrackingNumber("4PX3001359756959CN");
                createTrackingParams1.setCourierCode("4px");
                
                CreateTrackingParams createTrackingParams2 = new CreateTrackingParams();
                createTrackingParams2.setTrackingNumber("4PX3001490035975CN");
                createTrackingParams2.setCourierCode("4px");
...
Get status of the shipment:
    ...
    public class Get4PXTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                # trackingParams.setTrackingNumbers("4PX3001359756959CN,4PX3001490035975CN");
                trackingParams.setCourierCode("4px");
...
Update a tracking by ID:
    ...
    public class Update4PXTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                String idString = "9bc1bc577c8d0ca1c1f4ae4b4209728d";
